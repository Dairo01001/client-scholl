...
export default function ErrorPage () {
  ...
  return (
    <div className='h-screen w-screen bg-white dark:bg-gray-900 flex items-center'>
      <div className='container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 dark:text-gray-100'>
        <div className='max-w-md'>
          <div className='text-5xl font-dark font-bold'>{error.statusText || error.message}</div>
