...
export default function DrawerTeacher () {
  ...
  return (
    <div>
      ...
      <div
        className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto w-full md:w-96 transition-transform ${
      ...
      >
        ...
        <div className='py-4 overflow-y-auto'>
          <ul className='space-y-2 font-medium'>
            ...
            <li>
              <button
                className='flex text-left w-full p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'
                onClick={logout}
              >
                <svg
                  aria-hidden='true'
